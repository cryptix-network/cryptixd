...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := cryptixd.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = cryptixd.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = cryptixd.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
