...
import (
	...
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/blockwindowheapslicestore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/daawindowstore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/mergedepthrootstore"
	"github.com/cryptix-network/cryptixd/domain/consensus/model"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/blockparentbuilder"
	parentssanager "github.com/cryptix-network/cryptixd/domain/consensus/processes/parentsmanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/pruningproofmanager"
	...
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/blockstore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/consensusstatestore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/daablocksstore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/finalitystore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/ghostdagdatastore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/headersselectedchainstore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/headersselectedtipstore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/multisetstore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/pruningstore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/reachabilitydatastore"
	"github.com/cryptix-network/cryptixd/domain/consensus/datastructures/utxodiffstore"
	"github.com/cryptix-network/cryptixd/domain/consensus/model/externalapi"
	"github.com/cryptix-network/cryptixd/domain/consensus/model/testapi"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/blockbuilder"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/blockprocessor"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/blockvalidator"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/coinbasemanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/consensusstatemanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/dagtopologymanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/dagtraversalmanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/difficultymanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/finalitymanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/ghostdagmanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/headersselectedtipmanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/mergedepthmanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/pastmediantimemanager"
	"github.com/cryptix-network/cryptixd/domain/consensus/processes/pruningmanager"
