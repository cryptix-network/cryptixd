...
import (
	...
	"github.com/cryptix-network/cryptixd/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that cryptixd doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
