...
func generateTxs() (nativeTx, subnetworkTx *externalapi.DomainTransaction, err error) {
	...
	address1Str := "cryptixsim:qzpj2cfa9m40w9m2cmr8pvfuqpp32mzzwsuw6ukhfduqpp32mzzws59e8fapc"
	address1, err := util.DecodeAddress(address1Str, util.Bech32PrefixCryptixSim)
	if err != nil {
	...
	address2Str := "cryptixsim:qr7w7nqsdnc3zddm6u8s9fex4ysk95hm3v30q353ymuqpp32mzzws59e8fapc"
	address2, err := util.DecodeAddress(address2Str, util.Bech32PrefixCryptixSim)
	if err != nil {
...
func getSourceScript(b *testing.B) *externalapi.ScriptPublicKey {
	sourceAddressStr := "cryptixsim:qz6f9z6l3x4v3lf9mgf0t934th4nx5kgzu663x9yjh"

	sourceAddress, err := util.DecodeAddress(sourceAddressStr, util.Bech32PrefixCryptixSim)
	if err != nil {
