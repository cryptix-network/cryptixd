/*
Package txscript implements the cryptix transaction script language.

This package provides data structures and functions to parse and execute
cryptix transaction scripts.

# Script Overview

Cryptix transaction scripts are written in a stack-base, FORTH-like language.

The cryptix script language consists of a number of opcodes which fall into
...
Typical cryptix scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend cryptix.
