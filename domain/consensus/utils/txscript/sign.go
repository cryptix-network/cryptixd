...
// SignatureScript creates an input signature script for tx to spend CYTX sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend CYTX sent
