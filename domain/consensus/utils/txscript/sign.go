...
// SignatureScript creates an input signature script for tx to spend CPAY sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend CPAY sent
