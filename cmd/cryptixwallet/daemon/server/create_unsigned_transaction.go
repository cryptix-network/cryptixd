...
// By having at least 0.2CYTX in the change output we make sure that every transaction with send value >= 0.2CYTX
...
const minChangeTarget = constants.SompiPerCryptix / 5
