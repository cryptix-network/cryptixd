...
func sweep(conf *sweepConfig) error {
	...
	publicKeybytes, err := libcryptixwallet.PublicKeyFromPrivateKey(privateKeyBytes)
	if err != nil {
		return err
	}
	...
	UTXOs, err := libcryptixwallet.CryptixwalletdUTXOsTolibcryptixwalletUTXOs(getExternalSpendableUTXOsResponse.Entries)
	if err != nil {
		return err
	}
