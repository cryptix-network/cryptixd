	...
	tests := []struct {
		...
		// Positive P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixCryptix)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixCryptix,
		},
		{
			name:    "mainnet p2pk 2",
			...
			passedPrefix:   util.Bech32PrefixCryptix,
			expectedPrefix: util.Bech32PrefixCryptix,
		},
		{
			name:    "testnet p2pk",
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixCryptixTest)
			},
			passedPrefix:   util.Bech32PrefixCryptixTest,
			expectedPrefix: util.Bech32PrefixCryptixTest,
		},
		...
		// ECDSA P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixCryptix)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixCryptix,
		},
		...
		},
		{
			...
			addr:           "cryptix:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixCryptix,
			expectedPrefix: util.Bech32PrefixCryptix,
		},
		...
		// Positive P2SH tests.
		{
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixCryptix)
			},
			passedPrefix:   util.Bech32PrefixCryptix,
			expectedPrefix: util.Bech32PrefixCryptix,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixCryptix)
			},
			passedPrefix:   util.Bech32PrefixCryptix,
			expectedPrefix: util.Bech32PrefixCryptix,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixCryptixTest)
			},
			passedPrefix:   util.Bech32PrefixCryptixTest,
			expectedPrefix: util.Bech32PrefixCryptixTest,
		},
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"cryptix", util.Bech32PrefixCryptix, false},
		{"cryptixtest", util.Bech32PrefixCryptixTest, false},
		{"cryptixsim", util.Bech32PrefixCryptixSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixCryptix, "cryptix"},
		{util.Bech32PrefixCryptixTest, "cryptixtest"},
		{util.Bech32PrefixCryptixSim, "cryptixsim"},
		{util.Bech32PrefixUnknown, ""},
	}
