...
const (
	...
	Bech32PrefixCryptixDev

	// Prefix for the test network.
	Bech32PrefixCryptixTest

	// Prefix for the simulation network.
	Bech32PrefixCryptixSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"cryptix":     Bech32PrefixCryptix,
	"cryptixdev":  Bech32PrefixCryptixDev,
	"cryptixtest": Bech32PrefixCryptixTest,
	"cryptixsim":  Bech32PrefixCryptixSim,
}
...
// and a payload which encodes the cryptix network and address type. It is used
...
// with the passed cryptix network.
