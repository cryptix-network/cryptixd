...
// installService attempts to install the cryptixd service. Typically this should
...
// removeService attempts to uninstall the cryptixd service. Typically this should
...
// startService attempts to Start the cryptixd service.
