...
var (
	...
	DefaultAppDir = util.AppDir("cryptixd", false)
...
type Flags struct {
	...
	MinRelayTxFee                   float64       `long:"minrelaytxfee" description:"The minimum transaction fee in CYTX/kB to be considered a non-zero fee."`
...
//
// The above results in cryptixd functioning properly without any config settings
...
// createDefaultConfig copies the file sample-cryptixd.conf to the given destination path,
