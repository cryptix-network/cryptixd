...
func TestCrossLanguageVectorsMatch(t *testing.T) {
	vectors := []struct {
		...
		},
		{
			...
			nonce:      8894582,
			powHashHex: "000003867828f13ad967b222c180b6f75d5db14ca6e4804395113b93896cca15",
		},
		{
			network:    2,
			...
			nonce:      1588910,
			powHashHex: "000002136045d006fa98697640fed65804859d1d96342298c17c019243b61d97",
		},
		{
			network:    3,
			...
			nonce:      9081845,
			powHashHex: "0000000f4fce90bc93a2644f41cee1aa4774b367e49fce64a8d8fb49e160fe99",
		},
	}
