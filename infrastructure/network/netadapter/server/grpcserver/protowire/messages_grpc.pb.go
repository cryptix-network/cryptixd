...
type P2P_MessageStreamClient interface {
	Send(*CryptixdMessage) error
	Recv() (*CryptixdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *CryptixdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*CryptixdMessage, error) {
	m := new(CryptixdMessage)
...
func (x *p2PMessageStreamServer) Send(m *CryptixdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*CryptixdMessage, error) {
	m := new(CryptixdMessage)
...
func (x *rPCMessageStreamClient) Send(m *CryptixdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*CryptixdMessage, error) {
	m := new(CryptixdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *CryptixdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*CryptixdMessage, error) {
	m := new(CryptixdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
