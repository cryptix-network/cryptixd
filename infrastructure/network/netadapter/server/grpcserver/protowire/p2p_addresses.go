...
func (x *CryptixdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "CryptixdMessage_Addresses is nil")
	}
...
func (x *CryptixdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
