...
func (x *CryptixdMessage_GetBlocksRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_GetBlocksRequest is nil")
	}
	return x.GetBlocksRequest.toAppMessage()
}

func (x *CryptixdMessage_GetBlocksRequest) fromAppMessage(message *appmessage.GetBlocksRequestMessage) error {
...
func (x *CryptixdMessage_GetBlocksResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_GetBlocksResponse is nil")
	}
	return x.GetBlocksResponse.toAppMessage()
}

func (x *CryptixdMessage_GetBlocksResponse) fromAppMessage(message *appmessage.GetBlocksResponseMessage) error {
	var err *RPCError
