...
func (x *CryptixdMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *CryptixdMessage_RequestPruningPointUTXOSet) fromAppMessage(
