...
func (x *CryptixdMessage_NotifyUtxosChangedRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_NotifyUtxosChangedRequest is nil")
	}
	return x.NotifyUtxosChangedRequest.toAppMessage()
}

func (x *CryptixdMessage_NotifyUtxosChangedRequest) fromAppMessage(message *appmessage.NotifyUTXOsChangedRequestMessage) error {
...
func (x *CryptixdMessage_NotifyUtxosChangedResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *CryptixdMessage_NotifyUtxosChangedResponse) fromAppMessage(message *appmessage.NotifyUTXOsChangedResponseMessage) error {
	var err *RPCError
...
func (x *CryptixdMessage_UtxosChangedNotification) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_UtxosChangedNotification is nil")
	}
	return x.UtxosChangedNotification.toAppMessage()
}

func (x *CryptixdMessage_UtxosChangedNotification) fromAppMessage(message *appmessage.UTXOsChangedNotificationMessage) error {
