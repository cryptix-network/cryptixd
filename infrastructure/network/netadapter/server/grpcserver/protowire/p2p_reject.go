...
func (x *CryptixdMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_Reject is nil")
	}
...
func (x *CryptixdMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
