...
func (x *CryptixdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "CryptixdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *CryptixdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
