...
func (x *CryptixdMessage_InvTransactions) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_InvTransactions is nil")
	}
...
func (x *CryptixdMessage_InvTransactions) fromAppMessage(msgInvTransaction *appmessage.MsgInvTransaction) error {
