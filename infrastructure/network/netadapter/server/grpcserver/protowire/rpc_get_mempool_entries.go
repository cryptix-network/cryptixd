...
func (x *CryptixdMessage_GetMempoolEntriesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *CryptixdMessage_GetMempoolEntriesRequest) fromAppMessage(message *appmessage.GetMempoolEntriesRequestMessage) error {
...
func (x *CryptixdMessage_GetMempoolEntriesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_GetMempoolEntriesResponse is nil")
	}
	return x.GetMempoolEntriesResponse.toAppMessage()
}

func (x *CryptixdMessage_GetMempoolEntriesResponse) fromAppMessage(message *appmessage.GetMempoolEntriesResponseMessage) error {
	var rpcErr *RPCError
