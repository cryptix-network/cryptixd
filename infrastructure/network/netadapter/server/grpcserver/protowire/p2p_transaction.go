...
func (x *CryptixdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *CryptixdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
