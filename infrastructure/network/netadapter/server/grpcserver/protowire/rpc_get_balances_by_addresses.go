...
func (x *CryptixdMessage_GetBalancesByAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_GetBalanceByAddressRequest is nil")
	}
	return x.GetBalancesByAddressesRequest.toAppMessage()
}

func (x *CryptixdMessage_GetBalancesByAddressesRequest) fromAppMessage(message *appmessage.GetBalancesByAddressesRequestMessage) error {
...
func (x *CryptixdMessage_GetBalancesByAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *CryptixdMessage_GetBalancesByAddressesResponse) fromAppMessage(message *appmessage.GetBalancesByAddressesResponseMessage) error {
	var err *RPCError
