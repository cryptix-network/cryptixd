...
func (x *CryptixdMessage_GetConnectedPeerInfoRequest) toAppMessage() (appmessage.Message, error) {
	return &appmessage.GetConnectedPeerInfoRequestMessage{}, nil
}

func (x *CryptixdMessage_GetConnectedPeerInfoRequest) fromAppMessage(_ *appmessage.GetConnectedPeerInfoRequestMessage) error {
	return nil
}

func (x *CryptixdMessage_GetConnectedPeerInfoResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CryptixdMessage_GetConnectedPeerInfoResponse is nil")
	}
	return x.GetConnectedPeerInfoResponse.toAppMessage()
}

func (x *CryptixdMessage_GetConnectedPeerInfoResponse) fromAppMessage(message *appmessage.GetConnectedPeerInfoResponseMessage) error {
	var err *RPCError
	...
	for i, info := range message.Infos {
		infos[i] = &GetConnectedPeerInfoMessage{
			...
			AdvertisedServices:        info.AdvertisedServices,
			IsHfaFastchain:            info.IsHFAFastchain,
			IsCryptixAtomic:           info.IsCryptixAtomic,
			IsStrongNodeClaims:        info.IsStrongNodeClaims,
			IsArchival:                info.IsArchival,
...
func (x *GetConnectedPeerInfoMessage) toAppMessage() (*appmessage.GetConnectedPeerInfoMessage, error) {
	...
	return &appmessage.GetConnectedPeerInfoMessage{
		...
		AdvertisedServices:        x.AdvertisedServices,
		IsHFAFastchain:            x.IsHfaFastchain,
		IsCryptixAtomic:           x.IsCryptixAtomic,
		IsStrongNodeClaims:        x.IsStrongNodeClaims,
