/*
Package addressmanager implements concurrency safe Cryptix address manager.

# Address Manager Overview

In order maintain the peer-to-peer Cryptix network, there needs to be a source
of addresses to connect to as nodes come and go. The Cryptix protocol provides
