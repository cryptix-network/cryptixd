...
// MsgTransactionNotFound defines a cryptix TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new cryptix transactionsnotfound message that conforms to the
