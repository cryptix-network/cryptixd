...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a cryptix
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new cryptix RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
