...
// cryptix Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a cryptix
// Addresses message.
...
// NewMsgAddresses returns a new cryptix Addresses message that conforms to the
