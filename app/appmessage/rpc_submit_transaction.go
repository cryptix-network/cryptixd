...
// RPCTransaction is a cryptixd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a cryptixd transaction input representation
...
// RPCScriptPublicKey is a cryptixd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a cryptixd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a cryptixd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a cryptixd utxo entry representation meant to be used
// over RPC
