...
// MsgRequestTransactions implements the Message interface and represents a cryptix
...
// NewMsgRequestTransactions returns a new cryptix RequestTransactions message that conforms to
