...
// MsgRequestNextHeaders implements the Message interface and represents a cryptix
...
// NewMsgRequestNextHeaders returns a new cryptix RequestNextHeaders message that conforms to the
// Message interface.
