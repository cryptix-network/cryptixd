...
// MsgRequestRelayBlocks implements the Message interface and represents a cryptix
...
// NewMsgRequestRelayBlocks returns a new cryptix RequestRelayBlocks message that conforms to
