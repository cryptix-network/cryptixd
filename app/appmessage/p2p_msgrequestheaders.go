...
// MsgRequestHeaders implements the Message interface and represents a cryptix
...
// NewMsgRequstHeaders returns a new cryptix RequestHeaders message that conforms to the
