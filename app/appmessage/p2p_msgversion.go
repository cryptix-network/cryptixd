...
var DefaultUserAgent = fmt.Sprintf("/cryptixd:%s/", version.Version())

// MsgVersion implements the Message interface and represents a cryptix version
...
// NewMsgVersion returns a new cryptix version message that conforms to the
