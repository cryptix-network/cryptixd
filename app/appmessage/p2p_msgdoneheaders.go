...
// MsgDoneHeaders implements the Message interface and represents a cryptix
...
// NewMsgDoneHeaders returns a new cryptix DoneIBDBlocks message that conforms to the
// Message interface.
