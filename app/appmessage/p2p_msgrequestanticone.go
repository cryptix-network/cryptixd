...
// MsgRequestAnticone implements the Message interface and represents a cryptix
...
// NewMsgRequestAnticone returns a new cryptix RequestPastDiff message that conforms to the
