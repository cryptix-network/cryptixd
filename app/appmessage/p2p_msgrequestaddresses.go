...
// MsgRequestAddresses implements the Message interface and represents a cryptix
...
// NewMsgRequestAddresses returns a new cryptix RequestAddresses message that conforms to the
